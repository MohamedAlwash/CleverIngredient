...
public class RecipeTest {
    ...
    public void testAddIngrediënt() {
        ArrayList<String> ingrediënten4 = new ArrayList<String>(Arrays.asList("Komkommer", "sla", "tomaat", "kowed"));

        ArrayList<String> ingrediënten3 = new ArrayList<String>(Arrays.asList("Komkommer", "sla", "tomaat"));
        ...
        assertTrue(eenRecept.addIngrediënt(ingrediënten4));
        assertFalse(eenRecept.addIngrediënt(ingrediënten3));
        assertTrue(eenRecept.addIngrediënt(ingrediënten14));
        assertTrue(eenRecept.addIngrediënt(ingrediënten15));
        assertFalse(eenRecept.addIngrediënt(ingrediënten16));
    }
}